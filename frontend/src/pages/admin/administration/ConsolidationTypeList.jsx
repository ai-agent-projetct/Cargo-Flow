...
const ConsolidationTypeList = () => {
  ...
  const filtered = CONSOLIDATION_TYPES.filter((ct) =>
    !search ||
  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <h2 className="text-xl font-bold text-slate-900">Consolidation Type</h2>
      </div>

      <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        <MasterListToolbar
          rows={filtered}
          filename="consolidation-type"
          search={search}
          onSearch={setSearch}
        />
...
export default ConsolidationTypeList;
