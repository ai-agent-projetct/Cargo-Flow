...
const accountingReportRoutes = require('./accountingReports');
const accountingConfigRoutes = require('./accountingConfig');
const accountAssetRoutes = require('./accountAssets');
const accountingActionRoutes = require('./accountingActions');
...
const registerRoutes = (app, io) => {
  ...
  app.use('/api/accounting/config', accountingConfigRoutes);
  app.use('/api/accounting/assets', accountAssetRoutes);
  app.use('/api/accounting/actions', accountingActionRoutes);
